        ...
        >
          {certificates.map((cert, i) => (
            ...
            >
              ...
              {/* Certificate Image, PDF preview, or Badge */}
              {cert.image ? (
                ...
                <div className="relative mb-4 h-40 w-full overflow-hidden rounded-xl border border-[var(--border-card)] bg-[#fff] pointer-events-none flex items-center justify-center">
                  {/* PDF rendering hack for thumbnails */}
                  <iframe 
